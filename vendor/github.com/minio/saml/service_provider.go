...
// GetSLSBindingLocation returns URL for the IDP's Single Logout Service binding
// of the specified type (HTTPRedirectBinding or HTTPPostBinding)
func (sp *ServiceProvider) GetSLSBindingLocation(binding string) string {
	for _, idpSSODescriptor := range sp.IDPMetadata.IDPSSODescriptors {
...
func (sp *ServiceProvider) MakeLogoutRequest(idpURL string) *LogoutRequest {
